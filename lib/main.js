    ...
    startGame: function () {
        ...
        for (j = 0; j < this.thewords.length; j++) {
            if (jQuery.inArray(this.thewords[j], this.notintable) == -1)
                //thelist += 'xxx<span style="display:none;" id="list' + j + '">' + this.thewords[j] + '</span><br />';
...
$(document).ready(function () {
    ...
    $("#btn_start").hover(
        function () {
            this.src = this.src.replace("img/start1.png", "img/start0.png");
        },
        function () {
            this.src = this.src.replace("img/start0.png", "img/start1.png");
        }
    );
    $("#btn_new").hover(
        function () {
            this.src = this.src.replace("img/new1.png", "img/new0.png");
        },
        function () {
            this.src = this.src.replace("img/new0.png", "img/new1.png");
        }
    );
    $("#btn_reload").hover(
        function () {
            this.src = this.src.replace("img/reload1.png", "img/reload0.png");
        },
        function () {
            this.src = this.src.replace("img/reload0.png", "img/reload1.png");
        }
    );
    $("#btn_printable").hover(
        function () {
            this.src = this.src.replace("img/printable1.png", "img/printable0.png");
        },
        function () {
            this.src = this.src.replace("img/printable0.png", "img/printable1.png");
        }
    );
